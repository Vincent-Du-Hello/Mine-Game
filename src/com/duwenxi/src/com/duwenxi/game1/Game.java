...
public class Game extends Frame{
	...
	private void prepare() {
		...
		templv1i.addActionListener(new ActionListener() {
			@Override
		...
		templv1i.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				Tool.changeTexture(c);
			}
		});
		templv0.add(templv1i);
		templv1i = new Menu();
		templv1i.setLabel("设置格子大小");
		templv1i.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				IntInput in = new IntInput();
				in.setListener(new IntListener() {
					@Override
					public void onGet(int result) {
						Config.GRIDSIZE = result;
						c.reload();
						setSize(Config.WIDTH * Config.GRIDSIZE + 12, Config.HEIGHT * Config.GRIDSIZE + 52);
					}
				});
			}
		});
